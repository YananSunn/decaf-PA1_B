 ...
 * Generated at: Thu Nov 01 18:06:30 CST 2018
...
public class Table
 {
    ...
    public static final int Oper9 = 334;
    public static final int Program = 335;
    public static final int Expr = 336;
    public static final int ExprT40 = 337;
    ...
    public static final int IfList = 357;
    ...
    public static final int ConstantSubList = 362;
    public static final int Expr40 = 363;
    public static final int ClassList = 364;
    public static final int Oper4 = 365;
    ...
    private final String[] allSymbols = {
        ...
        "IfList", "IfStmt", "ExprT6", "ExprT8", "Expr7",
        "ConstantSubList", "Expr40", "ClassList", "Oper4", "Field",
    };
    ...
    private final Integer[][] beginRaw = {
        ...
        {Integer.valueOf('+'), Integer.valueOf('-'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), NEWSAMEARRAY},
        {NEWSAMEARRAY},
        {EQUAL, NOT_EQUAL},
        ...
        {BREAK},
        {AND, Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf(';'), Integer.valueOf('[')},
        ...
        {FOR},
        {LITERAL, NULL, Integer.valueOf('['), READ_INTEGER, READ_LINE, THIS, NEW, INSTANCEOF, Integer.valueOf('('), IDENTIFIER, Integer.valueOf('!'), Integer.valueOf('-')},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {Integer.valueOf('[')},
        {Integer.valueOf('{'), Integer.valueOf('(')},
        {OR},
        {ELSE, PRINT, VOID, FOR, Integer.valueOf('!'), Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        {NEWSAMEARRAY, Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('[')},
        ...
        {Integer.valueOf('{')},
        {Integer.valueOf('('), Integer.valueOf(';')},
        {Integer.valueOf('('), Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('.'), Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {JOINTARRAY},
        {CLASS, SEALED},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {JOINTARRAY, Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, AND, Integer.valueOf(';'), Integer.valueOf('[')},
        {VOID, CLASS, INT, STRING, BOOL},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        ...
        {VOID, CLASS, INT, STRING, BOOL},
        {EQUAL, NOT_EQUAL, Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), Integer.valueOf('='), OR, AND, Integer.valueOf(';'), Integer.valueOf('[')},
        {VOID, CLASS, INT, STRING, BOOL, Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, VAR, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), READ_INTEGER, IF, WHILE, FOR, RETURN, PRINT, BREAK, Integer.valueOf('{'), SCOPY},
        ...
        {WHILE},
        {OR, Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), Integer.valueOf('='), Integer.valueOf(';'), Integer.valueOf('[')},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {LESS_EQUAL, GREATER_EQUAL, Integer.valueOf('<'), Integer.valueOf('>'), Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('['), NEWSAMEARRAY},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER, Integer.valueOf(';')},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER, Integer.valueOf('}')},
        {IF},
        {Integer.valueOf('*'), Integer.valueOf('/'), Integer.valueOf('%'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), NEWSAMEARRAY},
        {Integer.valueOf('['), Integer.valueOf('.'), Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {Integer.valueOf('-'), Integer.valueOf('!'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {Integer.valueOf(','), Integer.valueOf(']')},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
    ...
    private final Integer[][] followRaw = {
        {PRINT, VOID, FOR, Integer.valueOf('!'), Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        {LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), NEWSAMEARRAY},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {Integer.valueOf(')')},
        ...
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {GUARDED, Integer.valueOf('}')},
        {Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('.'), Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('[')},
        {Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf(';'), Integer.valueOf('[')},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), NEWSAMEARRAY},
        {Integer.valueOf('}')},
        {Integer.valueOf(';')},
        {Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf(';'), Integer.valueOf('[')},
        {Integer.valueOf('}')},
        ...
        {PRINT, VOID, FOR, Integer.valueOf('!'), Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        {Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('.'), Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), Integer.valueOf('='), Integer.valueOf(';'), Integer.valueOf('[')},
        {Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('.'), Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {PRINT, VOID, FOR, Integer.valueOf('!'), Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {PRINT, VOID, FOR, Integer.valueOf('!'), Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        ...
        {Integer.valueOf(';')},
        {Integer.valueOf(')')},
        {PRINT, VOID, FOR, Integer.valueOf('!'), Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, STATIC, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        {VOID, CLASS, INT, Integer.valueOf('}'), STRING, STATIC, BOOL},
        {Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('.'), Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {eof, eos},
        {Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), Integer.valueOf('='), Integer.valueOf(';'), Integer.valueOf('[')},
        {Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, AND, Integer.valueOf(';'), Integer.valueOf('[')},
        {IDENTIFIER},
        {LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), NEWSAMEARRAY},
        {Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('.'), Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {Integer.valueOf(';'), Integer.valueOf(')')},
        ...
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {IDENTIFIER},
        {Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), Integer.valueOf('='), OR, AND, Integer.valueOf(';'), Integer.valueOf('[')},
        {Integer.valueOf(')')},
        {Integer.valueOf(';'), Integer.valueOf(','), Integer.valueOf(')')},
        {Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), Integer.valueOf('='), OR, AND, Integer.valueOf(';'), Integer.valueOf('[')},
        {PRINT, VOID, FOR, Integer.valueOf('!'), Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        ...
        {PRINT, VOID, FOR, Integer.valueOf('!'), Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        {Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), Integer.valueOf('='), Integer.valueOf(';'), Integer.valueOf('[')},
        {Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('['), NEWSAMEARRAY},
        {Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('['), NEWSAMEARRAY},
        {Integer.valueOf(';')},
        {Integer.valueOf('}')},
        {PRINT, VOID, FOR, Integer.valueOf('!'), Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        ...
        switch (nonTerminal) {
            ...
            case ExprT5: {
                switch (lookahead) {
                    ...
                    case '>':
                    case NEWSAMEARRAY:
                        return new AbstractMap.SimpleEntry<>(134, Arrays.asList());
                    default: return null;
                }
            }
            //# line 364
            ...
            case VariableList: {
                switch (lookahead) {
                    ...
                    case STRING:
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(9, Arrays.asList(Variable, SubVariableList));
                    default: return null;
                }
            }
            //# line 161
            case Formals: {
                switch (lookahead) {
                    ...
                    case STRING:
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(10, Arrays.asList(VariableList));
                    case ')':
                        return new AbstractMap.SimpleEntry<>(11, Arrays.asList());
                    default: return null;
                }
            }
            //# line 353
            ...
            case IfSubStmt: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(14, Arrays.asList(Expr, Integer.valueOf(':'), Stmt));
                    default: return null;
                }
            }
            //# line 626
            ...
            case Expr41: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(18, Arrays.asList(Expr4, ExprT41));
                    default: return null;
                }
            }
            //# line 413
            ...
            case Expr6: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(21, Arrays.asList(Expr7, ExprT6));
                    default: return null;
                }
            }
            //# line 913
            case IfBranchList: {
                switch (lookahead) {
                    case GUARDED:
                        return new AbstractMap.SimpleEntry<>(22, Arrays.asList(GUARDED, IfSubStmt, IfBranchList));
                    case '}':
                        return new AbstractMap.SimpleEntry<>(134, Arrays.asList());
                    default: return null;
                }
            ...
            case Constant: {
                switch (lookahead) {
                    ...
                    case '[':
                        return new AbstractMap.SimpleEntry<>(31, Arrays.asList(ArrayConstant));
                    default: return null;
                }
            }
            //# line 181
            ...
            case PrintStmt: {
                switch (lookahead) {
                    case PRINT:
                        return new AbstractMap.SimpleEntry<>(34, Arrays.asList(PRINT, Integer.valueOf('('), ExprList, Integer.valueOf(')')));
                    default: return null;
                }
            }
            //# line 780
            case ConstantList: {
                switch (lookahead) {
                    ...
                    case NULL:
                    case '[':
                        return new AbstractMap.SimpleEntry<>(35, Arrays.asList(Constant, ConstantSubList));
                    case ']':
            ...
            case Expr9: {
                switch (lookahead) {
                    ...
                    case '!':
                    case '-':
                        return new AbstractMap.SimpleEntry<>(46, Arrays.asList(Expr, Integer.valueOf('['), Expr, Integer.valueOf(':'), Expr, Integer.valueOf(']')));
                    default: return null;
                }
            }
            //# line 384
            ...
            case ArrayConstant: {
                switch (lookahead) {
                    case '[':
                        return new AbstractMap.SimpleEntry<>(48, Arrays.asList(Integer.valueOf('['), ConstantList, Integer.valueOf(']')));
                    default: return null;
                }
            }
            //# line 863
            case GuardedStmt: {
                switch (lookahead) {
                    case '{':
                        return new AbstractMap.SimpleEntry<>(49, Arrays.asList(Integer.valueOf('{'), IfList, Integer.valueOf('}')));
                    case '(':
                        return new AbstractMap.SimpleEntry<>(50, Arrays.asList(Integer.valueOf('('), Expr, Integer.valueOf(')'), Stmt, ElseClause));
                    default: return null;
                }
            }
            //# line 276
            case Oper1: {
                switch (lookahead) {
                    case OR:
                        return new AbstractMap.SimpleEntry<>(51, Arrays.asList(OR));
                    default: return null;
                }
            }
            //# line 873
            case ElseClause: {
                switch (lookahead) {
                    case ELSE:
                        return new AbstractMap.SimpleEntry<>(52, Arrays.asList(ELSE, Stmt));
                    case PRINT:
                    case VOID:
                    case FOR:
                    case '!':
            ...
            case ExprT41: {
                switch (lookahead) {
                    case NEWSAMEARRAY:
                        return new AbstractMap.SimpleEntry<>(54, Arrays.asList(Oper8, Expr4, ExprT41));
                    case ']':
                    case ':':
                    case EQUAL:
                    case ')':
            ...
            case SubExprList: {
                switch (lookahead) {
                    case ',':
                        return new AbstractMap.SimpleEntry<>(58, Arrays.asList(Integer.valueOf(','), Expr, SubExprList));
                    case ')':
                        return new AbstractMap.SimpleEntry<>(59, Arrays.asList());
                    default: return null;
                }
            }
            //# line 749
            case AfterParenExpr: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(60, Arrays.asList(Expr, Integer.valueOf(')')));
                    case CLASS:
                        return new AbstractMap.SimpleEntry<>(61, Arrays.asList(CLASS, IDENTIFIER, Integer.valueOf(')'), Expr9));
                    default: return null;
                }
            }
            //# line 103
            case ClassDef: {
                switch (lookahead) {
                    case CLASS:
                        return new AbstractMap.SimpleEntry<>(62, Arrays.asList(CLASS, IDENTIFIER, ExtendsClause, Integer.valueOf('{'), FieldList, Integer.valueOf('}')));
                    case SEALED:
                        return new AbstractMap.SimpleEntry<>(63, Arrays.asList(SEALED, CLASS, IDENTIFIER, ExtendsClause, Integer.valueOf('{'), FieldList, Integer.valueOf('}')));
                    default: return null;
                }
            }
            //# line 880
            ...
            case FunctionField: {
                switch (lookahead) {
                    ...
                    case ';':
                        return new AbstractMap.SimpleEntry<>(134, Arrays.asList(Integer.valueOf(';')));
                    default: return null;
                }
            }
            //# line 671
            ...
            case Oper9: {
                switch (lookahead) {
                    case JOINTARRAY:
                        return new AbstractMap.SimpleEntry<>(71, Arrays.asList(JOINTARRAY));
                    default: return null;
                }
            }
            //# line 28
            case Program: {
                switch (lookahead) {
                    case CLASS:
                    case SEALED:
                        return new AbstractMap.SimpleEntry<>(72, Arrays.asList(ClassDef, ClassList));
                    default: return null;
                }
            }
            //# line 378
            case Expr: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(73, Arrays.asList(Expr1));
                    default: return null;
                }
            }
            //# line 485
            case ExprT40: {
                switch (lookahead) {
                    case JOINTARRAY:
                        return new AbstractMap.SimpleEntry<>(74, Arrays.asList(Oper9, Expr41, ExprT40));
                    case ']':
                    case ':':
                    case EQUAL:
                    case ')':
            ...
            case Type: {
                switch (lookahead) {
                    ...
                    case STRING:
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(76, Arrays.asList(SimpleType, ArrayType));
                    default: return null;
                }
            }
            //# line 558
            case Expr5: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(77, Arrays.asList(Expr6, ExprT5));
                    default: return null;
                }
            }
            //# line 723
            case AfterNewExpr: {
                switch (lookahead) {
                    case IDENTIFIER:
                        return new AbstractMap.SimpleEntry<>(78, Arrays.asList(IDENTIFIER, Integer.valueOf('('), Integer.valueOf(')')));
                    case VOID:
                    case CLASS:
                    case INT:
                    case STRING:
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(79, Arrays.asList(SimpleType, Integer.valueOf('['), AfterSimpleTypeExpr));
                    default: return null;
                }
            }
            //# line 267
            case Assignment: {
                switch (lookahead) {
                    case '=':
                        return new AbstractMap.SimpleEntry<>(80, Arrays.asList(Integer.valueOf('='), Expr));
                    case ';':
                    case ')':
                        return new AbstractMap.SimpleEntry<>(134, Arrays.asList());
                    default: return null;
            ...
            case ExtendsClause: {
                switch (lookahead) {
                    case EXTENDS:
                        return new AbstractMap.SimpleEntry<>(82, Arrays.asList(EXTENDS, IDENTIFIER));
                    case '{':
                        return new AbstractMap.SimpleEntry<>(134, Arrays.asList());
                    default: return null;
                }
            ...
            case Oper5: {
                switch (lookahead) {
                    case '+':
                        return new AbstractMap.SimpleEntry<>(84, Arrays.asList(Integer.valueOf('+')));
                    case '-':
            ...
            case ArrayType: {
                switch (lookahead) {
                    case '[':
                        return new AbstractMap.SimpleEntry<>(86, Arrays.asList(Integer.valueOf('['), Integer.valueOf(']'), ArrayType));
                    case IDENTIFIER:
            ...
            case Expr3: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(88, Arrays.asList(Expr40, ExprT3));
                    default: return null;
                }
            }
            //# line 804
            case Actuals: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(89, Arrays.asList(ExprList));
                    case ')':
            ...
            case Variable: {
                switch (lookahead) {
                    ...
                    case STRING:
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(91, Arrays.asList(Type, IDENTIFIER));
                    default: return null;
                }
            }
            //# line 454
            case ExprT3: {
                switch (lookahead) {
                    case EQUAL:
                    case NOT_EQUAL:
                        return new AbstractMap.SimpleEntry<>(92, Arrays.asList(Oper3, Expr40, ExprT3));
                    case ']':
                    case ':':
                    case ')':
                    case ',':
            ...
            case Stmt: {
                switch (lookahead) {
                    ...
                    case STRING:
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(94, Arrays.asList(VariableDef));
                    case '!':
                    case '-':
                    case READ_LINE:
                    case NULL:
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(95, Arrays.asList(SimpleStmt, Integer.valueOf(';')));
                    case IF:
                        return new AbstractMap.SimpleEntry<>(96, Arrays.asList(IfStmt));
                    case WHILE:
                        return new AbstractMap.SimpleEntry<>(97, Arrays.asList(WhileStmt));
                    case FOR:
                        return new AbstractMap.SimpleEntry<>(98, Arrays.asList(ForStmt));
                    case RETURN:
                        return new AbstractMap.SimpleEntry<>(99, Arrays.asList(ReturnStmt, Integer.valueOf(';')));
                    case PRINT:
                        return new AbstractMap.SimpleEntry<>(100, Arrays.asList(PrintStmt, Integer.valueOf(';')));
                    case BREAK:
                        return new AbstractMap.SimpleEntry<>(101, Arrays.asList(BreakStmt, Integer.valueOf(';')));
                    case '{':
                        return new AbstractMap.SimpleEntry<>(102, Arrays.asList(StmtBlock));
                    case SCOPY:
            ...
            case SimpleStmt: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(104, Arrays.asList(Expr, Assignment));
                    case VAR:
                        return new AbstractMap.SimpleEntry<>(105, Arrays.asList(VAR, IDENTIFIER, Integer.valueOf('='), Expr));
                    case ';':
                    case ')':
                        return new AbstractMap.SimpleEntry<>(134, Arrays.asList());
                    default: return null;
            ...
            case SimpleType: {
                switch (lookahead) {
                    case INT:
                        return new AbstractMap.SimpleEntry<>(107, Arrays.asList(INT));
                    case VOID:
                        return new AbstractMap.SimpleEntry<>(108, Arrays.asList(VOID));
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(109, Arrays.asList(BOOL));
                    case STRING:
                        return new AbstractMap.SimpleEntry<>(110, Arrays.asList(STRING));
                    case CLASS:
                        return new AbstractMap.SimpleEntry<>(111, Arrays.asList(CLASS, IDENTIFIER));
                    default: return null;
                }
            }
            //# line 840
            case WhileStmt: {
                switch (lookahead) {
                    case WHILE:
                        return new AbstractMap.SimpleEntry<>(112, Arrays.asList(WHILE, Integer.valueOf('('), Expr, Integer.valueOf(')'), Stmt));
                    default: return null;
                }
            }
            //# line 396
            case ExprT1: {
                switch (lookahead) {
                    case OR:
                        return new AbstractMap.SimpleEntry<>(113, Arrays.asList(Oper1, Expr2, ExprT1));
                    case ']':
                    case ':':
                    case ')':
                    case ',':
            ...
            case Expr4: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(115, Arrays.asList(Expr5, ExprT4));
                    default: return null;
                }
            }
            //# line 541
            case ExprT4: {
                switch (lookahead) {
                    ...
                    case '<':
                    case '>':
                        return new AbstractMap.SimpleEntry<>(116, Arrays.asList(Oper4, Expr5, ExprT4));
                    case ']':
                    case ':':
                    case EQUAL:
                    case ')':
            ...
            case ReturnExpr: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(118, Arrays.asList(Expr));
                    case ';':
                        return new AbstractMap.SimpleEntry<>(134, Arrays.asList());
                    default: return null;
                }
            ...
            case IfList: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(120, Arrays.asList(IfSubStmt, IfBranchList));
                    case '}':
                        return new AbstractMap.SimpleEntry<>(121, Arrays.asList());
                    default: return null;
                }
            }
            //# line 858
            case IfStmt: {
                switch (lookahead) {
                    case IF:
                        return new AbstractMap.SimpleEntry<>(122, Arrays.asList(IF, GuardedStmt));
                    default: return null;
                }
            }
            //# line 599
            case ExprT6: {
                switch (lookahead) {
                    ...
                    case '/':
                    case '%':
                        return new AbstractMap.SimpleEntry<>(123, Arrays.asList(Oper6, Expr7, ExprT6));
                    case LESS_EQUAL:
                    case ']':
                    case GREATER_EQUAL:
                    case '-':
            ...
            case ExprT8: {
                switch (lookahead) {
                    case '[':
                        return new AbstractMap.SimpleEntry<>(125, Arrays.asList(Integer.valueOf('['), Expr, Integer.valueOf(']'), ExprT8));
                    case '.':
                        return new AbstractMap.SimpleEntry<>(126, Arrays.asList(Integer.valueOf('.'), IDENTIFIER, AfterIdentExpr, ExprT8));
                    case '/':
                    case LESS_EQUAL:
                    case ']':
                    case GREATER_EQUAL:
            ...
            case Expr7: {
                switch (lookahead) {
                    case '-':
                    case '!':
                        return new AbstractMap.SimpleEntry<>(128, Arrays.asList(Oper7, Expr8));
                    case READ_LINE:
                    case NULL:
                    case IDENTIFIER:
                    case NEW:
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(129, Arrays.asList(Expr8));
                    default: return null;
                }
            }
            //# line 793
            case ConstantSubList: {
                switch (lookahead) {
                    case ',':
                        return new AbstractMap.SimpleEntry<>(130, Arrays.asList(Integer.valueOf(','), Constant, ConstantSubList));
                    case ']':
                        return new AbstractMap.SimpleEntry<>(134, Arrays.asList());
                    default: return null;
                }
            ...
            case Expr40: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(132, Arrays.asList(Expr41, ExprT40));
                    default: return null;
                }
            }
            //# line 39
            case ClassList: {
                switch (lookahead) {
                    case CLASS:
                    case SEALED:
                        return new AbstractMap.SimpleEntry<>(133, Arrays.asList(ClassDef, ClassList));
                    case eof:
                    case eos:
                        return new AbstractMap.SimpleEntry<>(134, Arrays.asList());
                    default: return null;
            ...
            case Oper4: {
                switch (lookahead) {
                    case LESS_EQUAL:
                        return new AbstractMap.SimpleEntry<>(135, Arrays.asList(LESS_EQUAL));
                    case GREATER_EQUAL:
                        return new AbstractMap.SimpleEntry<>(136, Arrays.asList(GREATER_EQUAL));
                    case '<':
                        return new AbstractMap.SimpleEntry<>(137, Arrays.asList(Integer.valueOf('<')));
                    case '>':
                        return new AbstractMap.SimpleEntry<>(138, Arrays.asList(Integer.valueOf('>')));
                    default: return null;
                }
            }
            //# line 137
            case Field: {
                switch (lookahead) {
                    case STATIC:
                        return new AbstractMap.SimpleEntry<>(139, Arrays.asList(STATIC, Type, IDENTIFIER, Integer.valueOf('('), Formals, Integer.valueOf(')'), StmtBlock));
                    case VOID:
                    case CLASS:
                    case INT:
                    case STRING:
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(140, Arrays.asList(Type, IDENTIFIER, FunctionField));
                    default: return null;
                }
            }
            default: return null;
    ...
    public void act(int id, SemValue[] params) {
        switch (id) {
            ...
            case 46: {
                //# line 719
                params[0].expr = new Tree.AccessArray(params[1].expr, params[3].expr, params[5].expr, params[1].loc);
                return;
            }
            case 47: {
                //# line 385
