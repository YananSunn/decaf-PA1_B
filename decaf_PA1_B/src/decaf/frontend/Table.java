 ...
 * Generated at: Thu Nov 01 18:53:40 CST 2018
...
public class Table
 {
    ...
    public static final int BoundVariable = 297;
    ...
    public static final int ForeachStmt = 321;
    public static final int ArrayConstant = 322;
    public static final int GuardedStmt = 323;
    public static final int Oper1 = 324;
    public static final int ElseClause = 325;
    public static final int ExprT41 = 326;
    public static final int FieldList = 327;
    public static final int SubExprList = 328;
    public static final int AfterParenExpr = 329;
    public static final int ClassDef = 330;
    public static final int ReturnStmt = 331;
    public static final int ExprList = 332;
    public static final int StmtBlock = 333;
    public static final int FunctionField = 334;
    public static final int AfterIdentExpr = 335;
    public static final int Oper9 = 336;
    ...
    public static final int Variable = 349;
    public static final int ExprT3 = 350;
    public static final int Stmt = 351;
    public static final int SimpleStmt = 352;
    public static final int SimpleType = 353;
    public static final int WhileStmt = 354;
    public static final int ExprT1 = 355;
    public static final int Expr4 = 356;
    public static final int ExprT4 = 357;
    public static final int ReturnExpr = 358;
    public static final int IfList = 359;
    public static final int IfStmt = 360;
    public static final int ForeachSubStmt = 361;
    public static final int ExprT6 = 362;
    public static final int ExprT8 = 363;
    public static final int Expr7 = 364;
    public static final int ConstantSubList = 365;
    public static final int Expr40 = 366;
    public static final int ClassList = 367;
    public static final int Oper4 = 368;
    ...
    private final String[] allSymbols = {
        ...
        "BoundVariable", "Oper3", "Oper6", "VariableList", "Formals",
        "Oper7", "IfSubStmt", "Expr8", "AfterSimpleTypeExpr", "Expr41",
        "Expr2", "Oper2", "Expr6", "IfBranchList", "BreakStmt",
        "ExprT2", "StmtList", "Constant", "SubVariableList", "PrintStmt",
        "ConstantList", "ForStmt", "Expr9", "Expr1", "ForeachStmt",
        "ArrayConstant", "GuardedStmt", "Oper1", "ElseClause", "ExprT41",
        ...
        "ExprT4", "ReturnExpr", "IfList", "IfStmt", "ForeachSubStmt",
    ...
    private final Integer[][] beginRaw = {
        ...
        {Integer.valueOf('+'), Integer.valueOf('-'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('>'), NEWSAMEARRAY},
        {NEWSAMEARRAY},
        ...
        {Integer.valueOf('{'), Integer.valueOf('(')},
        {OR},
        {ELSE, PRINT, VOID, FOR, Integer.valueOf('!'), FOREACH, Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        {NEWSAMEARRAY, Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';')},
        ...
        {Integer.valueOf('{')},
        {Integer.valueOf('('), Integer.valueOf(';')},
        {Integer.valueOf('('), Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('.'), Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {JOINTARRAY},
        {CLASS, SEALED},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {JOINTARRAY, Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, AND, Integer.valueOf(';')},
        {VOID, CLASS, INT, STRING, BOOL},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        ...
        {VOID, CLASS, INT, STRING, BOOL, Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, VAR, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), READ_INTEGER, IF, WHILE, FOR, RETURN, PRINT, BREAK, Integer.valueOf('{'), SCOPY, FOREACH},
        ...
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {LESS_EQUAL, GREATER_EQUAL, Integer.valueOf('<'), Integer.valueOf('>'), Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), NEWSAMEARRAY},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER, Integer.valueOf(';')},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER, Integer.valueOf('}')},
        {IF},
        {WHILE, Integer.valueOf(')')},
        {Integer.valueOf('*'), Integer.valueOf('/'), Integer.valueOf('%'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('>'), NEWSAMEARRAY},
        {Integer.valueOf('['), Integer.valueOf('.'), Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {Integer.valueOf('-'), Integer.valueOf('!'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {Integer.valueOf(','), Integer.valueOf(']')},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
    ...
    private final Integer[][] followRaw = {
        {PRINT, VOID, FOR, Integer.valueOf('!'), FOREACH, Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        {LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('>'), NEWSAMEARRAY},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {IN},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        ...
        {READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {GUARDED, Integer.valueOf('}')},
        {Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {Integer.valueOf('/'), LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('.'), Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf('*'), Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('['), Integer.valueOf('>'), Integer.valueOf('%'), NEWSAMEARRAY},
        {Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';')},
        {Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, Integer.valueOf(';')},
        {Integer.valueOf('!'), Integer.valueOf('-'), READ_LINE, NULL, IDENTIFIER, NEW, THIS, INSTANCEOF, LITERAL, Integer.valueOf('('), Integer.valueOf('['), READ_INTEGER},
        {LESS_EQUAL, Integer.valueOf(']'), GREATER_EQUAL, Integer.valueOf('-'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, Integer.valueOf('+'), JOINTARRAY, AND, Integer.valueOf(';'), Integer.valueOf('<'), Integer.valueOf('>'), NEWSAMEARRAY},
        {Integer.valueOf('}')},
        {Integer.valueOf(';')},
        {Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, Integer.valueOf(';')},
        {Integer.valueOf('}')},
        ...
        {Integer.valueOf(';')},
        {Integer.valueOf(')')},
        {PRINT, VOID, FOR, Integer.valueOf('!'), FOREACH, Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, STATIC, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        ...
        {PRINT, VOID, FOR, Integer.valueOf('!'), FOREACH, Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        {Integer.valueOf(']'), Integer.valueOf(':'), Integer.valueOf(')'), Integer.valueOf(','), WHILE, Integer.valueOf('='), Integer.valueOf(';')},
        {Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), NEWSAMEARRAY},
        {Integer.valueOf(']'), Integer.valueOf(':'), EQUAL, Integer.valueOf(')'), NOT_EQUAL, Integer.valueOf(','), WHILE, Integer.valueOf('='), OR, JOINTARRAY, AND, Integer.valueOf(';'), NEWSAMEARRAY},
        {Integer.valueOf(';')},
        {Integer.valueOf('}')},
        {PRINT, VOID, FOR, Integer.valueOf('!'), FOREACH, Integer.valueOf('-'), GUARDED, CLASS, READ_LINE, WHILE, RETURN, NULL, INT, SCOPY, Integer.valueOf('}'), IDENTIFIER, NEW, IF, VAR, THIS, INSTANCEOF, STRING, LITERAL, ELSE, Integer.valueOf('('), Integer.valueOf(';'), Integer.valueOf('['), BOOL, BREAK, READ_INTEGER, Integer.valueOf('{')},
        ...
        switch (nonTerminal) {
            ...
            case Expr41: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(20, Arrays.asList(Expr4, ExprT41));
                    default: return null;
                }
            }
            //# line 438
            ...
            case IfBranchList: {
                switch (lookahead) {
                    case GUARDED:
                        return new AbstractMap.SimpleEntry<>(24, Arrays.asList(GUARDED, IfSubStmt, IfBranchList));
                    case '}':
                        return new AbstractMap.SimpleEntry<>(139, Arrays.asList());
                    default: return null;
                }
            ...
            case Constant: {
                switch (lookahead) {
                    ...
                    case '[':
                        return new AbstractMap.SimpleEntry<>(33, Arrays.asList(ArrayConstant));
                    default: return null;
                }
            }
            //# line 181
            ...
            case ConstantList: {
                switch (lookahead) {
                    ...
                    case NULL:
                    case '[':
                        return new AbstractMap.SimpleEntry<>(37, Arrays.asList(Constant, ConstantSubList));
                    case ']':
            ...
            case ForStmt: {
                switch (lookahead) {
                    case FOR:
                        return new AbstractMap.SimpleEntry<>(39, Arrays.asList(FOR, Integer.valueOf('('), SimpleStmt, Integer.valueOf(';'), Expr, Integer.valueOf(';'), SimpleStmt, Integer.valueOf(')'), Stmt));
                    default: return null;
                }
            }
            //# line 703
            case Expr9: {
                switch (lookahead) {
                    ...
                    case NULL:
                    case '[':
                        return new AbstractMap.SimpleEntry<>(40, Arrays.asList(Constant));
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(41, Arrays.asList(READ_INTEGER, Integer.valueOf('('), Integer.valueOf(')')));
                    case READ_LINE:
                        return new AbstractMap.SimpleEntry<>(42, Arrays.asList(READ_LINE, Integer.valueOf('('), Integer.valueOf(')')));
                    case THIS:
                        return new AbstractMap.SimpleEntry<>(43, Arrays.asList(THIS));
                    case NEW:
                        return new AbstractMap.SimpleEntry<>(44, Arrays.asList(NEW, AfterNewExpr));
                    case INSTANCEOF:
                        return new AbstractMap.SimpleEntry<>(45, Arrays.asList(INSTANCEOF, Integer.valueOf('('), Expr, Integer.valueOf(','), IDENTIFIER, Integer.valueOf(')')));
                    case '(':
                        return new AbstractMap.SimpleEntry<>(46, Arrays.asList(Integer.valueOf('('), AfterParenExpr));
                    case IDENTIFIER:
                        return new AbstractMap.SimpleEntry<>(47, Arrays.asList(IDENTIFIER, AfterIdentExpr));
                    default: return null;
                }
            }
            //# line 409
            case Expr1: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(48, Arrays.asList(Expr2, ExprT1));
                    default: return null;
                }
            }
            //# line 255
            case ForeachStmt: {
                switch (lookahead) {
                    case FOREACH:
                        return new AbstractMap.SimpleEntry<>(49, Arrays.asList(FOREACH, Integer.valueOf('('), BoundVariable, IN, Expr, ForeachSubStmt, Integer.valueOf(')'), Stmt));
                    default: return null;
                }
            }
            //# line 795
            case ArrayConstant: {
                switch (lookahead) {
                    case '[':
                        return new AbstractMap.SimpleEntry<>(50, Arrays.asList(Integer.valueOf('['), ConstantList, Integer.valueOf(']')));
                    default: return null;
                }
            }
            //# line 884
            case GuardedStmt: {
                switch (lookahead) {
                    case '{':
                        return new AbstractMap.SimpleEntry<>(51, Arrays.asList(Integer.valueOf('{'), IfList, Integer.valueOf('}')));
                    case '(':
                        return new AbstractMap.SimpleEntry<>(52, Arrays.asList(Integer.valueOf('('), Expr, Integer.valueOf(')'), Stmt, ElseClause));
                    default: return null;
                }
            }
            //# line 301
            ...
            case ExprT41: {
                switch (lookahead) {
                    case NEWSAMEARRAY:
                        return new AbstractMap.SimpleEntry<>(56, Arrays.asList(Oper8, Expr4, ExprT41));
                    case ']':
                    case ':':
                    case EQUAL:
                    case ')':
            ...
            case FieldList: {
                switch (lookahead) {
                    ...
                    case STATIC:
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(58, Arrays.asList(Field, FieldList));
                    case '}':
            ...
            case SubExprList: {
                switch (lookahead) {
                    case ',':
                        return new AbstractMap.SimpleEntry<>(60, Arrays.asList(Integer.valueOf(','), Expr, SubExprList));
                    case ')':
                        return new AbstractMap.SimpleEntry<>(61, Arrays.asList());
                    default: return null;
                }
            }
            //# line 770
            case AfterParenExpr: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(62, Arrays.asList(Expr, Integer.valueOf(')')));
                    case CLASS:
                        return new AbstractMap.SimpleEntry<>(63, Arrays.asList(CLASS, IDENTIFIER, Integer.valueOf(')'), Expr9));
                    default: return null;
                }
            }
            //# line 103
            case ClassDef: {
                switch (lookahead) {
                    case CLASS:
                        return new AbstractMap.SimpleEntry<>(64, Arrays.asList(CLASS, IDENTIFIER, ExtendsClause, Integer.valueOf('{'), FieldList, Integer.valueOf('}')));
                    case SEALED:
                        return new AbstractMap.SimpleEntry<>(65, Arrays.asList(SEALED, CLASS, IDENTIFIER, ExtendsClause, Integer.valueOf('{'), FieldList, Integer.valueOf('}')));
                    default: return null;
                }
            }
            //# line 901
            case ReturnStmt: {
                switch (lookahead) {
                    case RETURN:
                        return new AbstractMap.SimpleEntry<>(66, Arrays.asList(RETURN, ReturnExpr));
                    default: return null;
                }
            }
            //# line 835
            case ExprList: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(67, Arrays.asList(Expr, SubExprList));
                    default: return null;
                }
            }
            //# line 192
            case StmtBlock: {
                switch (lookahead) {
                    case '{':
                        return new AbstractMap.SimpleEntry<>(68, Arrays.asList(Integer.valueOf('{'), StmtList, Integer.valueOf('}')));
                    default: return null;
                }
            }
            //# line 153
            case FunctionField: {
                switch (lookahead) {
                    case '(':
                        return new AbstractMap.SimpleEntry<>(69, Arrays.asList(Integer.valueOf('('), Formals, Integer.valueOf(')'), StmtBlock));
                    case ';':
            ...
            case AfterIdentExpr: {
                switch (lookahead) {
                    case '(':
                        return new AbstractMap.SimpleEntry<>(71, Arrays.asList(Integer.valueOf('('), Actuals, Integer.valueOf(')')));
                    case '/':
                    case LESS_EQUAL:
                    case ']':
                    case GREATER_EQUAL:
            ...
            case Oper9: {
                switch (lookahead) {
                    case JOINTARRAY:
                        return new AbstractMap.SimpleEntry<>(73, Arrays.asList(JOINTARRAY));
                    default: return null;
                }
            }
            //# line 28
            ...
            case ExprT40: {
                switch (lookahead) {
                    case JOINTARRAY:
                        return new AbstractMap.SimpleEntry<>(76, Arrays.asList(Oper9, Expr41, ExprT40));
                    case ']':
                    case ':':
                    case EQUAL:
                    case ')':
            ...
            case Expr3: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(90, Arrays.asList(Expr40, ExprT3));
                    default: return null;
                }
            }
            //# line 825
            ...
            case Variable: {
                switch (lookahead) {
                    ...
                    case STRING:
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(93, Arrays.asList(Type, IDENTIFIER));
                    default: return null;
                }
            }
            //# line 479
            case ExprT3: {
                switch (lookahead) {
                    case EQUAL:
                    case NOT_EQUAL:
                        return new AbstractMap.SimpleEntry<>(94, Arrays.asList(Oper3, Expr40, ExprT3));
                    case ']':
                    case ':':
                    case ')':
                    case ',':
            ...
            case Stmt: {
                switch (lookahead) {
                    ...
                    case STRING:
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(96, Arrays.asList(VariableDef));
                    case '!':
                    case '-':
                    case READ_LINE:
                    case NULL:
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(97, Arrays.asList(SimpleStmt, Integer.valueOf(';')));
                    case IF:
                        return new AbstractMap.SimpleEntry<>(98, Arrays.asList(IfStmt));
                    case WHILE:
                        return new AbstractMap.SimpleEntry<>(99, Arrays.asList(WhileStmt));
                    case FOR:
                        return new AbstractMap.SimpleEntry<>(100, Arrays.asList(ForStmt));
                    case RETURN:
                        return new AbstractMap.SimpleEntry<>(101, Arrays.asList(ReturnStmt, Integer.valueOf(';')));
                    case PRINT:
                        return new AbstractMap.SimpleEntry<>(102, Arrays.asList(PrintStmt, Integer.valueOf(';')));
                    case BREAK:
                        return new AbstractMap.SimpleEntry<>(103, Arrays.asList(BreakStmt, Integer.valueOf(';')));
                    case '{':
                        return new AbstractMap.SimpleEntry<>(104, Arrays.asList(StmtBlock));
                    case SCOPY:
                        return new AbstractMap.SimpleEntry<>(105, Arrays.asList(SCOPY, Integer.valueOf('('), IDENTIFIER, Integer.valueOf(','), Expr, Integer.valueOf(')')));
                    case FOREACH:
                        return new AbstractMap.SimpleEntry<>(106, Arrays.asList(ForeachStmt));
                    default: return null;
                }
            }
            //# line 277
            case SimpleStmt: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(107, Arrays.asList(Expr, Assignment));
                    case VAR:
                        return new AbstractMap.SimpleEntry<>(108, Arrays.asList(VAR, IDENTIFIER, Integer.valueOf('='), Expr));
                    case ';':
                    case ')':
                        return new AbstractMap.SimpleEntry<>(139, Arrays.asList());
                    default: return null;
            ...
            case SimpleType: {
                switch (lookahead) {
                    case INT:
                        return new AbstractMap.SimpleEntry<>(110, Arrays.asList(INT));
                    case VOID:
                        return new AbstractMap.SimpleEntry<>(111, Arrays.asList(VOID));
                    case BOOL:
                        return new AbstractMap.SimpleEntry<>(112, Arrays.asList(BOOL));
                    case STRING:
                        return new AbstractMap.SimpleEntry<>(113, Arrays.asList(STRING));
                    case CLASS:
                        return new AbstractMap.SimpleEntry<>(114, Arrays.asList(CLASS, IDENTIFIER));
                    default: return null;
                }
            }
            //# line 861
            case WhileStmt: {
                switch (lookahead) {
                    case WHILE:
                        return new AbstractMap.SimpleEntry<>(115, Arrays.asList(WHILE, Integer.valueOf('('), Expr, Integer.valueOf(')'), Stmt));
                    default: return null;
                }
            }
            //# line 421
            case ExprT1: {
                switch (lookahead) {
                    case OR:
                        return new AbstractMap.SimpleEntry<>(116, Arrays.asList(Oper1, Expr2, ExprT1));
                    case ']':
                    case ':':
                    case ')':
                    case ',':
            ...
            case Expr4: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(118, Arrays.asList(Expr5, ExprT4));
                    default: return null;
                }
            }
            //# line 566
            case ExprT4: {
                switch (lookahead) {
                    ...
                    case '<':
                    case '>':
                        return new AbstractMap.SimpleEntry<>(119, Arrays.asList(Oper4, Expr5, ExprT4));
                    case ']':
                    case ':':
                    case EQUAL:
                    case ')':
            ...
            case ReturnExpr: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(121, Arrays.asList(Expr));
                    case ';':
                        return new AbstractMap.SimpleEntry<>(139, Arrays.asList());
                    default: return null;
                }
            ...
            case IfList: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(123, Arrays.asList(IfSubStmt, IfBranchList));
                    case '}':
                        return new AbstractMap.SimpleEntry<>(124, Arrays.asList());
                    default: return null;
                }
            }
            //# line 879
            case IfStmt: {
                switch (lookahead) {
                    case IF:
                        return new AbstractMap.SimpleEntry<>(125, Arrays.asList(IF, GuardedStmt));
                    default: return null;
                }
            }
            //# line 260
            case ForeachSubStmt: {
                switch (lookahead) {
                    case WHILE:
                        return new AbstractMap.SimpleEntry<>(126, Arrays.asList(WHILE, Expr));
                    case ')':
                        return new AbstractMap.SimpleEntry<>(139, Arrays.asList());
                    default: return null;
                }
            ...
            case ConstantSubList: {
                switch (lookahead) {
                    case ',':
                        return new AbstractMap.SimpleEntry<>(135, Arrays.asList(Integer.valueOf(','), Constant, ConstantSubList));
                    case ']':
                        return new AbstractMap.SimpleEntry<>(139, Arrays.asList());
                    default: return null;
                }
            ...
            case Expr40: {
                switch (lookahead) {
                    ...
                    case '[':
                    case READ_INTEGER:
                        return new AbstractMap.SimpleEntry<>(137, Arrays.asList(Expr41, ExprT40));
                    default: return null;
                }
            }
            //# line 39
